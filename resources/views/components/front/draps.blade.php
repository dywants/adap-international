        ...
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8">
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-6 lg:gap-16 place-content-stretch">
                <div class="col-span-2 relative h-64 overflow-hidden rounded-lg sm:h-80 lg:order-last lg:h-full">
                    <img alt="{{ __('home.section-1.title') }}" src="{{ asset('/assets/images/personnes-mains.jpeg') }}"
                            ...
                            <div class="flex flex-col justify-start w-1/4 space-y-4">
                                ...
                                <a class="px-4 py-2 text-2xl"
                                   ...
                                   href="#" @click.prevent="tab = 2">
                                    {{ __('home.section-0.title') }}
                                </a>

                            </div>
                            <div class="w-3/4">
                                <p class="space-y-6 text-xl leading-9" x-show="tab === 1" x-transition:enter="transition duration-500 transform ease-in" x-transition:enter-start="opacity-0">
                                    {{ __('home.section-1.text') }}
                                </p>

                                <p class="space-y-6 text-xl leading-9" x-show="tab === 2" x-transition:enter="transition duration-500 transform ease-in" x-transition:enter-start="opacity-0">
                                    {{ __('home.section-0.text') }}
                                </p>
                            </div>
                        </div>
                    </section>

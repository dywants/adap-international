    ...
    <div class="max-w-screen-xl mx-auto px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8">
        <div class="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
            <div class="mx-auto max-w-lg text-center lg:mx-0 lg:text-left">
                <h2 class="text-3xl font-bold sm:text-4xl">Notre mission</h2>

                <p class="mt-4 text-gray-700">
                    Œuvrer pour l’amélioration de la qualité de vie, le rapprochement des communautés africaines à travers les secteurs de l’éducation et de l’entrepreneuriat jeune, la préservation de l’environnement, le renforcement de l’économie locale, la promotion de la paix, le développement du potentiel sportif et l’accès aux services de base
                </p>
            ...
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-3">
                ...
                <a class="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring"
                    href="#">
                    <span class="inline-block rounded-lg bg-gray-50 p-3">
                        <svg class="w-6 h-6" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
...
<g>
	...
	<path class="st0" d="M134.872,227.196c-20.23-24.656-37.018-46.956-43.656-60.473l5.58-6.683c-0.011-0.008-0.022-0.023-0.022-0.023
		...
		c-12.002,16-113.171,135.806-113.171,135.806l100.457,84.537C127.228,257.77,130.544,243.151,134.872,227.196z"/>
                    ...
                    <h2 class="mt-2 font-bold">Sport & Loisir</h2>

                    <p class="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600">
                        Promouvoir les activités et infrastructures sportives dans les quartiers
                        défavorisés
                    </p>
                </a>
                ...
                <a class="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring"
                    ...
                    <h2 class="mt-2 font-bold">Tourisme Africain</h2>
                ...
                <a class="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring"
                    ...
                    <h2 class="mt-2 font-bold">Culture</h2>
                ...
                <a class="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring"
                    ...
                    <h2 class="mt-2 font-bold">Droit de l'homme</h2>

        ...
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8">
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
                <div class="relative h-64 overflow-hidden rounded-lg sm:h-80 lg:order-last lg:h-full">
                    <img alt="Party" src="{{ asset('/assets/images/personnes-mains.jpeg') }}" class="absolute inset-0 h-full w-full object-cover"/>
                </div>
                ...
                <div class="lg:py-24">
                    ...
                    <a href="#" class="mt-8 inline-block rounded bg-secondary px-12 py-3 text-sm font-medium text-white transition hover:opacity-75 focus:outline-none focus:ring focus:ring-yellow-400">
                        LEARN ABOUT US
                    </a>
                </div>
            </div>
...
<!-- Icon Blocks -->
    ...
    <div class="grid md:grid-cols-2 gap-6 lg:gap-12">
      <div class="space-y-6 lg:space-y-10">
        ...
        <!-- Icon Block -->
        <div class="flex">
           <svg class="w-10 h-10" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                       viewBox="0 0 512 512"  xml:space="preserve">
          <style type="text/css">
          	.st0{fill:#000000;}
          </style>
          <g>
          	<path class="st0" d="M264.144,416.889L14.642,205.12L0,222.38l249.532,211.798l0.034,0.03
          		c28.365,23.868,64.366,37.003,101.443,37.01h159.922v-22.638H351.01C319.292,448.581,288.402,437.322,264.144,416.889z"/>
          	<path class="st0" d="M203.394,336.186l56.013,47.136c-2.07-10.412-6.623-21.543-15.617-31.812
          		c-6.968-7.966-21.928-24.401-39.924-44.533C203.397,316.698,203.21,326.524,203.394,336.186z"/>
          	<path class="st0" d="M141.098,205.698c-9.717-8.664-18.354-16.682-25.496-23.824c6.923,10.704,13.333,20.425,22.882,32.494
          		C139.323,211.511,140.198,208.624,141.098,205.698z"/>
          	<path class="st0" d="M194.91,251.657c-14.556-12.107-28.463-23.816-41.054-34.745c-0.893,4.133-1.785,8.371-2.64,12.729
          		c9.852,11.312,22.541,24.874,39.826,42.291C192.187,265.361,193.466,258.587,194.91,251.657z"/>
          	<path class="st0" d="M330.506,424.022c-0.372-18.197-4.4-63.248-33.957-88.205c-27.911-23.568-59.254-49.094-88.812-73.532
          	...
          	<path class="st0" d="M143.198,285.524l41.136,34.617c0.946-9.032,2.205-19.405,3.886-30.746
          		c-12.943-14.635-26.625-30.327-39.594-45.689C146.277,257.298,144.327,271.497,143.198,285.524z"/>
          	<path class="st0" d="M134.872,227.196c-20.23-24.656-37.018-46.956-43.656-60.473l5.58-6.683c-0.011-0.008-0.022-0.023-0.022-0.023
      ...
      <div class="space-y-6 lg:space-y-10">
        <!-- Icon Block -->
        <div class="flex">
           <svg fill="#000000" class="w-6 h-6" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <div class="flex">
          <svg class="w-10 h-10" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                   ...
                                   <path d="M8 7.27273C8 7.27273 15 4 24 4C33 4 40 7.27273 40 7.27273V13H8V7.27273Z" fill="#2F88FF" stroke="#000000" stroke-width="4" stroke-linejoin="round"/>
                                   <path d="M10 13V38" stroke="#000000" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M17 13V38" stroke="#000000" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
...
<!-- Features -->
  ...
  <div class="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
    <div>
      <img class="rounded-xl bg-contain" src="{{asset('assets/images/association.jpeg')}}" alt="Image Description">
    </div>
    <!-- End Col -->
      ...
      <div class="space-y-6 sm:space-y-8">
        ...
        <div class="space-y-2 md:space-y-4">
          <h2 class="font-bold text-3xl lg:text-4xl text-gray-800">
           ...
           <p class="text-base font-light text-gray-500 md:text-lg leading-7">Promouvoir auprès de ceux et celles de la diaspora la culture du retour aux sources afin de contribuer au développement et à la prospérité du continent africain.</p>
        </div>
        <!-- End Title -->
...
<!-- End Features -->
      ...
      <div class="relative p-6 md:p-16">
        ...
        <div class="relative z-10 lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center">
          <div class="mb-10 lg:mb-0 lg:col-span-6 lg:col-start-8 lg:order-2">
            ...
            <p class="text-base font-light text-gray-500 md:text-lg leading-7">Initiative de collecte et remise de matériels médicaux aux hôpitaux</p>
            ...
            <div class="relative">
              <!-- Tab Content -->
                <div id="tabs-with-card-1" role="tabpanel" aria-labelledby="tabs-with-card-item-1">
                  <img class="shadow-xl shadow-gray-200 rounded-xl bg-cover h-auto" src="{{asset('assets/images/association.jpeg')}}" alt="Image Description">
                </div>
              <!-- End Tab Content -->
    ...
    <div class="max-w-5xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <a class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800" href="#">
          <div class="p-4 md:p-5">
            <div class="flex justify-center items-center">
              <svg class="mt-1 shrink-0 w-6 h-6 text-gray-800 dark:text-gray-200" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
        ...
        <!-- Card -->
        <a class="group group-hover:shadow-2xl flex flex-col cursor-pointer justify-center items-center bg-secondary border shadow-sm rounded-xl hover:shadow-md transition " href="#">
          <div class="p-4 md:p-5">
            <div class="flex justify-center items-center">
        ...
        <!-- Card -->
        <a class="group flex flex-col justify-center items-center bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800" href="#">
          <div class="p-4 md:p-5">
            <div class="flex justify-center items-center">
              <svg class="mt-1 shrink-0 w-5 h-5 text-gray-800 dark:text-gray-200" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              ...
              <div class="grow ml-5">
                <h3 class="group-hover:text-secondary font-semibold text-gray-800 dark:group-hover:text-gray-400">
                  Email us
                </h3>
                <p class="text-sm text-gray-500">
...
<!-- Clients -->
  ...
  <!-- Title -->
    <div class="sm:w-1/2 xl:w-2/3 mx-auto text-center mb-6">
       <h2 class="text-xl font-semibold md:text-2xl md:leading-tight text-gray-800 ">Dans le cadre de nos missions sociales et humanitaire, nous sommes accompagnés par les partenaires au développement</h2>
    </div>
  <!-- End Title -->
  ...
  <!-- Grid -->
    ...
    <a class="flex-shrink-0 transition hover:-translate-y-1" href="#">
      <svg class="w-6 h-6 md:w-10 md:h-10 mx-auto sm:mx-0" width="48" height="55" viewBox="0 0 48 55" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a class="flex-shrink-0 transition hover:-translate-y-1" href="#">
      <svg class="w-6 h-6 md:w-10 md:h-10 mx-auto sm:mx-0" width="48" height="42" viewBox="0 0 48 42" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a class="flex-shrink-0 transition hover:-translate-y-1" href="#">
      <svg class="w-6 h-6 md:w-10 md:h-10 mx-auto sm:mx-0" width="48" height="51" viewBox="0 0 48 51" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a class="flex-shrink-0 transition hover:-translate-y-1" href="#">
      <svg class="w-6 h-6 md:w-10 md:h-10 mx-auto sm:mx-0" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a class="flex-shrink-0 transition hover:-translate-y-1" href="#">
      <svg class="w-6 h-6 md:w-10 md:h-10 mx-auto sm:mx-0" width="48" height="50" viewBox="0 0 1280 1280" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M840.951 900.754C805.253 931.279 734.002 952.097 651.929 952.097C551.197 952.097 466.767 920.737 444.363 878.561C436.354 902.732 434.558 930.396 434.558 948.068C434.558 948.068 429.281 1034.84 489.636 1095.2C489.636 1063.86 515.042 1038.46 546.381 1038.46C600.097 1038.46 600.036 1085.32 599.987 1123.34C599.986 1124.48 599.984 1125.61 599.984 1126.73C599.984 1184.44 635.255 1233.91 685.416 1254.77C677.924 1239.36 673.721 1222.05 673.721 1203.77C673.721 1148.73 706.034 1128.23 743.588 1104.41L743.588 1104.41C773.469 1085.46 806.668 1064.41 829.548 1022.17C841.486 1000.13 848.265 974.893 848.265 948.068C848.265 931.573 845.702 915.676 840.951 900.754Z" fill="url(#paint1_linear_709_1103afaw)"/>
        <defs>
          <linearGradient id="paint0_linear_709_11012gh4" x1="882.997" y1="27.1132" x2="638.955" y2="866.902" gradientUnits="userSpaceOnUse">
            <stop stop-color="#000014"/>
            <stop offset="1" stop-color="#150426"/>
          </linearGradient>
          <linearGradient id="paint1_linear_709_1103afaw" x1="1001.68" y1="652.45" x2="790.326" y2="1094.91" gradientUnits="userSpaceOnUse">
    ...
    <a class="flex-shrink-0 transition hover:-translate-y-1" href="#">
      <svg class="w-6 h-6 md:w-10 md:h-10 mx-auto sm:mx-0" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 70 70">
...
<!-- End Clients -->
    <!-- End Card Section -->
    <section class="bg-cover relative bg-center bg-no-repeat" style="background-image: url('{{ asset('assets/images/projet-forage/p-forage-2.jpeg')}}'); z-index: -1;">

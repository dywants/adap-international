...
@section('content')
        ...
        <div class="relative mx-auto h-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:items-center lg:px-8">
            <div class="max-w-2xl text-center sm:text-left">
                ...
                <p class="mt-4 max-w-lg sm:text-xl sm:leading-relaxed">
                    Nous vous faisons visite guidées du Cameroun à coût réduit.
                </p>
    ...
    <section class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <span class="md:grow md:ml-5">
          <span
              class="hs-tab-active:text-blue-600 block font-semibold text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">All-in-one workspace</span>
      ...
      <span class="md:flex">
        ...
        <span class="md:grow md:ml-5">
          <span
              class="hs-tab-active:text-blue-600 block font-semibold text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">Automation on a whole new level</span>
      ...
      <span class="md:flex">
        ...
        <span class="md:grow md:ml-5">
          <span
              class="hs-tab-active:text-blue-600 block font-semibold text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">Solving problems for every team</span>
                ...
                <div class="space-y-6 sm:space-y-8">
                    ...
                    <ul role="list" class="space-y-2 sm:space-y-4">
                        ...
                        <li class="flex space-x-3">
                            ...
                            <span class="text-sm sm:text-base text-gray-500">Valorisant et soutenant le personne demunies</span>
                        </li>
                    </ul>
                    <!-- End List -->
                </div>
